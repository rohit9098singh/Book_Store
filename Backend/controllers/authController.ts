...
export const forgotPassword=async (req: Request, res: Response) => {
   try {
      ...
      return response(res,200,"A password reset link has been send to your email address")
   } catch (error:any) {
    console.log(error);
    return response(res, 500, "Internal server error", error.message);
   }
...
export const resetPassword=async(req:Request,res:Response)=>{
  try {
    ...
    const newpassword=req.body;
      ...
      return response(res, 200, "your password has been reset successfully now you can login with your new password");
